...
const HeroSection = () => {
  return (
    ...
    >
      {/* Decorative blobs */}
      <div className="absolute top-20 left-10 w-72 h-72 bg-peach/40 rounded-full blur-3xl" />
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-lavender/40 rounded-full blur-3xl" />
      ...
      <div className="container mx-auto px-4 md:px-8 flex flex-col lg:flex-row items-center gap-12 relative z-10">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-lg mx-auto lg:mx-0 mb-8 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            Custom cakes, brownies, cupcakes & more for every celebration. From birthday surprises to wedding wonders — we make it special.
          </p>
        ...
        {/* Hero image */}
        <div className="flex-1 flex justify-center animate-fade-in-scale" style={{ animationDelay: "0.3s" }}>
          <div className="relative">
            <div className="w-80 h-80 md:w-96 md:h-96 rounded-full bg-card shadow-2xl overflow-hidden border-4 border-white/60 animate-float">
              <img
            ...
            {/* Mini floating badge */}
            <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-card rounded-full px-6 py-2 shadow-lg border border-border">
              <span className="text-sm font-medium text-foreground">✨ 100% Fresh & Eggless Options</span>
            </div>
          </div>
        </div>
      </div>
