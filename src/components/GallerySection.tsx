...
const images = [
  ...
  { src: "/gallery/cake_daisy_enhanced.png", alt: "Daisy flower cake" },
  ...
  { src: "/gallery/cake_nandini_enhanced.png", alt: "Custom name cake" },
  ...
  { src: "/gallery/cake_sneha_enhanced.png", alt: "Custom celebration cake" },
